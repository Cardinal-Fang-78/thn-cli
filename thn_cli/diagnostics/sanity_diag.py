...
# ---------------------------------------------------------------------------
# Compatibility placeholder for sanity diagnostics runner (used by commands)
# ---------------------------------------------------------------------------


def run_sanity() -> dict:
    """
    Placeholder sanity diagnostic aggregator.
    Allows CLI imports to function during early development.
    """
    return {
        "status": "ok",
        "message": "run_sanity placeholder",
        "diagnostics": [],
    }
